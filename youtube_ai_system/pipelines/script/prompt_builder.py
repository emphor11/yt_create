    ...
    def build(
        ...
        *,
        ...
        return (
            ...
            "* If a SCRIPT STRATEGY BRIEF is present, forbidden_drift is a hard boundary. Do not use those topics directly or as paraphrased advice\n"
            "* If forbidden_drift includes general budgeting advice, do not write 50/30/20, set a budget, track expenses, or cash-envelope style body scenes. Keep body scenes on the selected mechanisms and leave practical action for the outro\n"
            ...
            "* Do NOT use repeated filler transitions like \"As we'll see\" or repeated vague warnings like \"serious consequences for our finances\". Make each transition name the next concrete mechanism or number.\n"
            "* Do NOT use bland advisory filler like \"make informed financial decisions\", \"achieve your financial goals\", \"use them wisely\", \"be mindful of your finances\", \"make the most of your money\", or \"live a life of luxury and freedom\". Replace it with a concrete cost, obligation, payment, interest, or cash-flow consequence.\n"
    ...
    def build_brief_prompt(
        ...
        *,
        ...
        return (
            ...
            "* recurring_example must be concrete and reusable across every body scene: name the object, decision, bill, purchase, payment, investment, or cash-flow situation.\n"
            "* recurring_example must not be vague text like \"money habits\", \"finance decision\", or \"the topic\".\n"
            ...
            "* scene_function_map scene_index values must be consecutive from 1 to BODY_SCENE_COUNT.\n"
            "* Each scene function must do a distinct job in the argument.\n"
            "* Body scene functions should explain mechanisms, consequences, reversals, limits, or examples. Do not use generic summary/takeaway/advice functions unless selected_format is action_plan.\n"
            "* If forbidden_drift includes general budgeting advice, scene_function_map must not include budgeting, 50/30/20, track expenses, spend less, or generic strategies. Put any practical action in the outro only.\n"
            ...
            "* If the topic is not about salary, do not use the old salary/day-20 curriculum in thesis, recurring_example, or scene functions.\n\n"
