...
class MediaService:
    ...
    def _outro_section_intelligence(self, narration: str) -> dict:
        ...
        actions = self._outro_actions(narration)
        ...
        visual_plan = [
            {
                ...
                "beats": {
                    "beats": [
                        {"component": "OutroRecapVisualizer", "text": actions[0]["label"], "emphasis": "normal", "data": {**outro_data, "active_action": actions[0]}},
                        {"component": "OutroRecapVisualizer", "text": "Build the system", "emphasis": "subtle", "data": outro_data},
                        {"component": "OutroRecapVisualizer", "text": punch, "emphasis": "hero", "data": outro_data},
                    ]
                },
            }
        ]
