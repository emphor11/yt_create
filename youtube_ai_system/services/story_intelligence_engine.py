...
from ..pipelines.story.intelligence_constants import (
    AGENDA_FILLER,
    ARC_TYPES,
    BAD_AGENDA_ENDINGS,
...
class StoryIntelligenceEngine:
    ...
    _WEIGHTS = SECTION_WEIGHTS
    _GENERIC_HOOK_PREFIXES = GENERIC_HOOK_PREFIXES
    _SECTION_PRIORITY = SECTION_PRIORITY
    _TERMINAL_SECTION_TYPES = TERMINAL_SECTION_TYPES
    _OPENING_SECTION_TYPES = OPENING_SECTION_TYPES
    _AGENDA_FILLER = AGENDA_FILLER
    _BAD_AGENDA_ENDINGS = BAD_AGENDA_ENDINGS
    _CONTRADICTION_TOKENS = CONTRADICTION_TOKENS
